...
// From finalize.cc
template void linear_output_stationary<100, 50, 2>(
    FM_TYPE input[100],
    WT_TYPE weight[50][100],
    WT_TYPE bias[50],
    hls::stream<array<FM_TYPE, 2>>& output
);
template void linear_input_stationary<50, 25, 2>(
    hls::stream<array<FM_TYPE, 2>>& input,
    WT_TYPE weight[25][50],
    WT_TYPE bias[25],
    FM_TYPE output[25]
);
template void linear<25, 1, 1, false>(
    FM_TYPE input[25],
    WT_TYPE weight[1][25],
    WT_TYPE bias[1],
    FM_TYPE output[1]
