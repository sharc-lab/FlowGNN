...
// From finalize.cc
template void linear_output_stationary<EMB_DIM, GRAPH_MLP_1_OUT, MLP_PARALLEL>(
    FM_TYPE input[EMB_DIM],
    WT_TYPE weight[GRAPH_MLP_1_OUT][EMB_DIM],
    WT_TYPE bias[GRAPH_MLP_1_OUT],
    hls::stream<array<FM_TYPE, MLP_PARALLEL>>& output
);
template void linear_input_stationary<GRAPH_MLP_1_OUT, GRAPH_MLP_2_OUT, MLP_PARALLEL>(
    hls::stream<array<FM_TYPE, MLP_PARALLEL>>& input,
    WT_TYPE weight[GRAPH_MLP_2_OUT][GRAPH_MLP_1_OUT],
    WT_TYPE bias[GRAPH_MLP_2_OUT],
    FM_TYPE output[GRAPH_MLP_2_OUT]
);
template void linear<GRAPH_MLP_2_OUT, NUM_TASK, NUM_TASK, false>(
    FM_TYPE input[GRAPH_MLP_2_OUT],
    WT_TYPE weight[NUM_TASK][GRAPH_MLP_2_OUT],
